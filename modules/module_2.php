...
<section class="left-bar">
    ...
    <h4>
        ...
        <h4><a href="../part2/2_1-main.php" class="module-choice" style="color: #02aab0;"> docenianie czyli budowanie fundamentu adekwatnego poczucia własnej wartości</a></h4>
        <ul>
        <li><a href="2_1.php" class="button-choice">co zyskasz realizujac ten moduł?</a></li>
        ...
        <li><a href="2_6.php" class="button-choice">rozwój</a></li>
        <li><a href="2_7.php" class="button-choice">10 błędów popełnianych przez dobrych rodziców</a></li>
        </ul>
