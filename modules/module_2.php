...
<section class="left-bar">
    ...
    <h4>
        <a href="module_1.php" name="main-1-1-choice" class="module-choice">wartości, czyli o ukrytych motywach naszego dzialania</a>
    </h4>
   
    <form action="module_2.php" method="post">
        <h4><a href="module_2.php" class="module-choice" style="color: #02aab0;"> docenianie czyli budowanie fundamentu adekwatnego poczucia własnej wartości</a></h4>
        ...
        <h4><a href="module_4.php" class="module-choice"> przyszłość</a></h4>
...
<section class="content content3">
    ...
    if(isset($_POST['choice1'])){
        include_once("part2/2_1.html");}
    elseif(isset($_POST['choice2'])){
        include_once('part2/2_2.html');}
    elseif(isset($_POST['choice3'])){
        include_once('part2/2_3.html');}
    elseif(isset($_POST['choice4'])){
        include_once('part2/2_4.html');}
    elseif(isset($_POST['choice5'])){
        include_once('part2/2_5.html');}
    elseif(isset($_POST['choice6'])){
        include_once('part2/2_6.html');}
    elseif(isset($_POST['choice7'])){
        include_once('part2/2_7.html');}
    else{
        include_once('part2/2_1-main.html');
    }
    ?>
</section>
</section>
