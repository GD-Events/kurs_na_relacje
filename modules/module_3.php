...
<section class="left-bar">
    ...
    <h4>
        ...
        <form action="module_3.php" method="post">
        <h4><a href="module_3.php" class="module-choice" style="color: #02aab0;"> omówienie, czyli świętowanie sukcesow i analizowanie porażek</a></h4>
...
<section class="content content3">
    ...
    if(isset($_POST['choice1'])){
        include_once("part3/3_1.html");}
    elseif(isset($_POST['choice2'])){
        include_once('part3/3_2.html');
    }
    elseif(isset($_POST['choice3'])){
        include_once('part3/3_3.html');}
    elseif(isset($_POST['choice4'])){
        include_once('part3/3_4.html');}
    elseif(isset($_POST['choice5'])){
        include_once('part3/3_5.html');}
    elseif(isset($_POST['choice6'])){
        include_once('part3/3_6.html');}
    elseif(isset($_POST['choice7'])){
        include_once('part3/3_7.html');}
        else{
            include_once('part3/3_1-main.html');
        }
    ?>
</section>
</section>
...
<style>
    body{
    background-image:url(../images/grafika_przewodnia_opacity.png);
