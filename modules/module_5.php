...
<section class="left-bar">
    ...
    <h4>
        ...
        <form action="module_5.php" method="post">
        <h4><a href="module_5.php" class="module-choice" style="color: #02aab0;"> wartośc, czyli o ukrytych motywach naszego działania</a></h4>
...
<section class="content content3">
    ...
    if(isset($_POST['choice1'])){
        include_once("part5/5_1.html");}
    elseif(isset($_POST['choice2'])){
        include_once('part5/5_2.html');
    }
    elseif(isset($_POST['choice3'])){
        include_once('part5/5_3.html');}
    elseif(isset($_POST['choice4'])){
        include_once('part5/5_4.html');}
    elseif(isset($_POST['choice5'])){
        include_once('part5/5_5.html');}
    elseif(isset($_POST['choice6'])){
        include_once('part5/5_6.html');}
    elseif(isset($_POST['choice7'])){
        include_once('part5/5_7.html');}
        else{
            include_once('part5/5_1-main.html');
        }
    ?>
</section>
</section>
