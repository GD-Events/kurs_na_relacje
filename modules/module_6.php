...
<section class="left-bar">
    ...
    <h4>
        ...
        <h4><a href="module_6.php" class="module-choice" style="color: #02aab0;"> oceny z zachowania</a></h4>
...
<section class="content content3">
    ...
    if(isset($_POST['choice1'])){
        include_once("part6/6_1.html");}
    elseif(isset($_POST['choice2'])){
        include_once('part6/6_2.html');
    }
    elseif(isset($_POST['choice3'])){
        include_once('part6/6_3.html');}
    elseif(isset($_POST['choice4'])){
        include_once('part6/6_4.html');}
    elseif(isset($_POST['choice5'])){
        include_once('part6/6_5.html');}
    elseif(isset($_POST['choice6'])){
        include_once('part6/6_6.html');}
    elseif(isset($_POST['choice7'])){
        include_once('part6/6_7.html');}
    else{
            include_once('part6/6_1-main.html');
        }
    ?>
</section>
</section>
