...
<section class="left-bar">
    ...
    <h4>
        ...
        <h4><a href="../part4/4_1-main.php" class="module-choice" style="color: #02aab0;"> przyszłość</a></h4>
        <ul>
        <li><a href="4_1.php" class="button-choice">co zyskasz realizujac ten moduł?</a></li>
        ...
        <li><a href="4_6.php" class="button-choice">rozwój</a></li>
        <li><a href="4_7.php" class="button-choice">10 błędów popełnianych przez dobrych rodziców</a></li>
        </ul>
